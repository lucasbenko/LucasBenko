...
<head>
    ...
    <title>Resume - Lucas Benko</title>
        ...
        <main>
            <div class="row justify-content-center">
                <div class="col-md-6 justify-content-center">
                    <img src="res/resume.png" class="img-fluid">
                </div>
            </div>

            <div class="row justify-content-center">
                <div class="col-md-6 d-flex justify-content-center my-4">
                    <a href="res/resume.pdf" class="btn" style="background-color: #e6615a; border-color: #e6615a; color: #fff;" target="_blank">View as PDF</a>
                </div>
            </div>
